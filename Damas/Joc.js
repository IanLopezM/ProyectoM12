class Joc {
	...
	omplirDades(nomEquip1, nomEquip2, quantFitxes1, quantFitxes2) {
		...
		player2.innerHTML = "&#128081 " + nomEquip2 +  " &#128081;";
	...
	canviarEquip() {
		...
		if (this._equipActual === false) {
			document.getElementById("player1").innerHTML = this._nomEquip1;
			document.getElementById("player2").innerHTML = "&#128081 " + this._nomEquip2 + " 128081&#128081";
		} else {
			document.getElementById("player1").innerHTML = "&#128081 " + this._nomEquip1 + " &#128081";
			document.getElementById("player2").innerHTML = this._nomEquip2;
		}
	}
